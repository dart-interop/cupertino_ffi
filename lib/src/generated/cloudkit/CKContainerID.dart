...
class CKContainerID extends Struct {
  /// Allocates a new instance of CKContainerID.
  static Pointer<CKContainerID> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CKContainerID>('CKContainerID');
  }
}

extension CKContainerIDPointer on Pointer<CKContainerID> {
  @ObjcMethodInfo(
  ...
  @ObjcMethodInfo(
    selector: 'initWithContainerIdentifier:environment:',
    returnType: '@',
    parameterTypes: ['@', ':', '@', 'q'],
  )
  ...
  @ObjcMethodInfo(
    selector: 'initWithDictionaryRepresentation:',
    returnType: '@',
    parameterTypes: ['@', ':', '@'],
  )
