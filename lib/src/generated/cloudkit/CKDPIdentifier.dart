...
class CKDPIdentifier extends Struct {
  /// Allocates a new instance of CKDPIdentifier.
  static Pointer<CKDPIdentifier> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CKDPIdentifier>('CKDPIdentifier');
  }
}

extension CKDPIdentifierPointer on Pointer<CKDPIdentifier> {
  @ObjcMethodInfo(
