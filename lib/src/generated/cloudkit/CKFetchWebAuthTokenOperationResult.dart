...
class CKFetchWebAuthTokenOperationResult extends Struct {
  /// Allocates a new instance of CKFetchWebAuthTokenOperationResult.
  static Pointer<CKFetchWebAuthTokenOperationResult> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CKFetchWebAuthTokenOperationResult>(
        'CKFetchWebAuthTokenOperationResult');
  }
}

extension CKFetchWebAuthTokenOperationResultPointer
    on Pointer<CKFetchWebAuthTokenOperationResult> {
  @ObjcMethodInfo(
