...
class CNAccountIdentifierDescription extends Struct {
  /// Allocates a new instance of CNAccountIdentifierDescription.
  static Pointer<CNAccountIdentifierDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNAccountIdentifierDescription>(
        'CNAccountIdentifierDescription');
  }
}

extension CNAccountIdentifierDescriptionPointer
    on Pointer<CNAccountIdentifierDescription> {
  @ObjcMethodInfo(
