...
class CNCropRectDescription extends Struct {
  /// Allocates a new instance of CNCropRectDescription.
  static Pointer<CNCropRectDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc
        .allocateByClassName<CNCropRectDescription>('CNCropRectDescription');
  }
}

extension CNCropRectDescriptionPointer on Pointer<CNCropRectDescription> {
  @ObjcMethodInfo(
