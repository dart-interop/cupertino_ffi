...
class CNDepartmentDescription extends Struct {
  /// Allocates a new instance of CNDepartmentDescription.
  static Pointer<CNDepartmentDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNDepartmentDescription>(
        'CNDepartmentDescription');
  }
}

extension CNDepartmentDescriptionPointer on Pointer<CNDepartmentDescription> {
  @ObjcMethodInfo(
