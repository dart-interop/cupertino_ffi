...
class CNFamilyNameDescription extends Struct {
  /// Allocates a new instance of CNFamilyNameDescription.
  static Pointer<CNFamilyNameDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNFamilyNameDescription>(
        'CNFamilyNameDescription');
  }
}

extension CNFamilyNameDescriptionPointer on Pointer<CNFamilyNameDescription> {
  @ObjcMethodInfo(
