...
class CNInstantMessageAddressesDescription extends Struct {
  /// Allocates a new instance of CNInstantMessageAddressesDescription.
  static Pointer<CNInstantMessageAddressesDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNInstantMessageAddressesDescription>(
        'CNInstantMessageAddressesDescription');
  }
}

extension CNInstantMessageAddressesDescriptionPointer
    on Pointer<CNInstantMessageAddressesDescription> {
  @ObjcMethodInfo(
