...
class CNJobTitleDescription extends Struct {
  /// Allocates a new instance of CNJobTitleDescription.
  static Pointer<CNJobTitleDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc
        .allocateByClassName<CNJobTitleDescription>('CNJobTitleDescription');
  }
}

extension CNJobTitleDescriptionPointer on Pointer<CNJobTitleDescription> {
  @ObjcMethodInfo(
