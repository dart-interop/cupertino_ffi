...
class CNLinkIdentifierDescription extends Struct {
  /// Allocates a new instance of CNLinkIdentifierDescription.
  static Pointer<CNLinkIdentifierDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNLinkIdentifierDescription>(
        'CNLinkIdentifierDescription');
  }
}

extension CNLinkIdentifierDescriptionPointer
    on Pointer<CNLinkIdentifierDescription> {
  @ObjcMethodInfo(
