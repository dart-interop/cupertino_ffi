...
class CNMiddleNameDescription extends Struct {
  /// Allocates a new instance of CNMiddleNameDescription.
  static Pointer<CNMiddleNameDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNMiddleNameDescription>(
        'CNMiddleNameDescription');
  }
}

extension CNMiddleNameDescriptionPointer on Pointer<CNMiddleNameDescription> {
  @ObjcMethodInfo(
