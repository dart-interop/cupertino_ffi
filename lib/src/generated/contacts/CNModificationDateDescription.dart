...
class CNModificationDateDescription extends Struct {
  /// Allocates a new instance of CNModificationDateDescription.
  static Pointer<CNModificationDateDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNModificationDateDescription>(
        'CNModificationDateDescription');
  }
}

extension CNModificationDateDescriptionPointer
    on Pointer<CNModificationDateDescription> {
  @ObjcMethodInfo(
