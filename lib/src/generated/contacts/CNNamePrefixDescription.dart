...
class CNNamePrefixDescription extends Struct {
  /// Allocates a new instance of CNNamePrefixDescription.
  static Pointer<CNNamePrefixDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNNamePrefixDescription>(
        'CNNamePrefixDescription');
  }
}

extension CNNamePrefixDescriptionPointer on Pointer<CNNamePrefixDescription> {
  @ObjcMethodInfo(
