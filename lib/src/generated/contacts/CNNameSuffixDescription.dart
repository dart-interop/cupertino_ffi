...
class CNNameSuffixDescription extends Struct {
  /// Allocates a new instance of CNNameSuffixDescription.
  static Pointer<CNNameSuffixDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNNameSuffixDescription>(
        'CNNameSuffixDescription');
  }
}

extension CNNameSuffixDescriptionPointer on Pointer<CNNameSuffixDescription> {
  @ObjcMethodInfo(
