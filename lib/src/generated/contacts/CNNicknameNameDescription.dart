...
class CNNicknameNameDescription extends Struct {
  /// Allocates a new instance of CNNicknameNameDescription.
  static Pointer<CNNicknameNameDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNNicknameNameDescription>(
        'CNNicknameNameDescription');
  }
}

extension CNNicknameNameDescriptionPointer
    on Pointer<CNNicknameNameDescription> {
  @ObjcMethodInfo(
