...
class CNNoteDescription extends Struct {
  /// Allocates a new instance of CNNoteDescription.
  static Pointer<CNNoteDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNNoteDescription>('CNNoteDescription');
  }
}

extension CNNoteDescriptionPointer on Pointer<CNNoteDescription> {
  @ObjcMethodInfo(
