...
class CNOrganizationNameDescription extends Struct {
  /// Allocates a new instance of CNOrganizationNameDescription.
  static Pointer<CNOrganizationNameDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNOrganizationNameDescription>(
        'CNOrganizationNameDescription');
  }
}

extension CNOrganizationNameDescriptionPointer
    on Pointer<CNOrganizationNameDescription> {
  @ObjcMethodInfo(
