...
class CNPhonemeDataDescription extends Struct {
  /// Allocates a new instance of CNPhonemeDataDescription.
  static Pointer<CNPhonemeDataDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNPhonemeDataDescription>(
        'CNPhonemeDataDescription');
  }
}

extension CNPhonemeDataDescriptionPointer on Pointer<CNPhonemeDataDescription> {
  @ObjcMethodInfo(
