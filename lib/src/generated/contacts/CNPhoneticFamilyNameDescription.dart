...
class CNPhoneticFamilyNameDescription extends Struct {
  /// Allocates a new instance of CNPhoneticFamilyNameDescription.
  static Pointer<CNPhoneticFamilyNameDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNPhoneticFamilyNameDescription>(
        'CNPhoneticFamilyNameDescription');
  }
}

extension CNPhoneticFamilyNameDescriptionPointer
    on Pointer<CNPhoneticFamilyNameDescription> {
  @ObjcMethodInfo(
