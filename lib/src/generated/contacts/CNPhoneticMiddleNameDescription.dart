...
class CNPhoneticMiddleNameDescription extends Struct {
  /// Allocates a new instance of CNPhoneticMiddleNameDescription.
  static Pointer<CNPhoneticMiddleNameDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNPhoneticMiddleNameDescription>(
        'CNPhoneticMiddleNameDescription');
  }
}

extension CNPhoneticMiddleNameDescriptionPointer
    on Pointer<CNPhoneticMiddleNameDescription> {
  @ObjcMethodInfo(
