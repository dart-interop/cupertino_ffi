...
class CNPhoneticOrganizationNameDescription extends Struct {
  /// Allocates a new instance of CNPhoneticOrganizationNameDescription.
  static Pointer<CNPhoneticOrganizationNameDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNPhoneticOrganizationNameDescription>(
        'CNPhoneticOrganizationNameDescription');
  }
}

extension CNPhoneticOrganizationNameDescriptionPointer
    on Pointer<CNPhoneticOrganizationNameDescription> {
  @ObjcMethodInfo(
