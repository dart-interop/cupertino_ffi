...
class CNPreferredForImageDescription extends Struct {
  /// Allocates a new instance of CNPreferredForImageDescription.
  static Pointer<CNPreferredForImageDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNPreferredForImageDescription>(
        'CNPreferredForImageDescription');
  }
}

extension CNPreferredForImageDescriptionPointer
    on Pointer<CNPreferredForImageDescription> {
  @ObjcMethodInfo(
