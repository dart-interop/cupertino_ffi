...
class CNPreferredLikenessSourceDescription extends Struct {
  /// Allocates a new instance of CNPreferredLikenessSourceDescription.
  static Pointer<CNPreferredLikenessSourceDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNPreferredLikenessSourceDescription>(
        'CNPreferredLikenessSourceDescription');
  }
}

extension CNPreferredLikenessSourceDescriptionPointer
    on Pointer<CNPreferredLikenessSourceDescription> {
  @ObjcMethodInfo(
