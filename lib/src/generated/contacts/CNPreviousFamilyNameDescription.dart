...
class CNPreviousFamilyNameDescription extends Struct {
  /// Allocates a new instance of CNPreviousFamilyNameDescription.
  static Pointer<CNPreviousFamilyNameDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNPreviousFamilyNameDescription>(
        'CNPreviousFamilyNameDescription');
  }
}

extension CNPreviousFamilyNameDescriptionPointer
    on Pointer<CNPreviousFamilyNameDescription> {
  @ObjcMethodInfo(
