...
class CNSocialProfilesDescription extends Struct {
  /// Allocates a new instance of CNSocialProfilesDescription.
  static Pointer<CNSocialProfilesDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNSocialProfilesDescription>(
        'CNSocialProfilesDescription');
  }
}

extension CNSocialProfilesDescriptionPointer
    on Pointer<CNSocialProfilesDescription> {
  @ObjcMethodInfo(
