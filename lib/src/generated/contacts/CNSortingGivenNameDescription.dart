...
class CNSortingGivenNameDescription extends Struct {
  /// Allocates a new instance of CNSortingGivenNameDescription.
  static Pointer<CNSortingGivenNameDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNSortingGivenNameDescription>(
        'CNSortingGivenNameDescription');
  }
}

extension CNSortingGivenNameDescriptionPointer
    on Pointer<CNSortingGivenNameDescription> {
  @ObjcMethodInfo(
