...
class CNUrlAddressesDescription extends Struct {
  /// Allocates a new instance of CNUrlAddressesDescription.
  static Pointer<CNUrlAddressesDescription> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<CNUrlAddressesDescription>(
        'CNUrlAddressesDescription');
  }
}

extension CNUrlAddressesDescriptionPointer
    on Pointer<CNUrlAddressesDescription> {
  @ObjcMethodInfo(
