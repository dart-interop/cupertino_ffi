...
class NSDateInterval extends Struct {
  /// Allocates a new instance of NSDateInterval.
  static Pointer<NSDateInterval> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<NSDateInterval>('NSDateInterval');
  }
}

extension NSDateIntervalPointer on Pointer<NSDateInterval> {
  @ObjcMethodInfo(
    selector: 'compare:',
    returnType: 'q',
    parameterTypes: ['@', ':', '@'],
  ...
  Pointer initWithStartDate$endDate(
    Pointer arg, {
  ...
  Pointer initWithStartDate$duration(
    Pointer arg, {
  ...
  Pointer intersectionWithDateInterval(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_returns_ptr(
