...
class NSFalsePredicate extends Struct {
  /// Allocates a new instance of NSFalsePredicate.
  static Pointer<NSFalsePredicate> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<NSFalsePredicate>('NSFalsePredicate');
  }
}

extension NSFalsePredicatePointer on Pointer<NSFalsePredicate> {
  @ObjcMethodInfo(
