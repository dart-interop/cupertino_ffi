...
class NSISO8601DateFormatter extends Struct {
  /// Allocates a new instance of NSISO8601DateFormatter.
  static Pointer<NSISO8601DateFormatter> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc
        .allocateByClassName<NSISO8601DateFormatter>('NSISO8601DateFormatter');
  }
}

extension NSISO8601DateFormatterPointer on Pointer<NSISO8601DateFormatter> {
  @ObjcMethodInfo(
  ...
  @ObjcMethodInfo(
    selector: 'updateFormatter',
    returnType: 'v',
    parameterTypes: ['@', ':'],
  )
  Pointer updateFormatter() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_returns_ptr(
      this,
      _objc.getSelector(
