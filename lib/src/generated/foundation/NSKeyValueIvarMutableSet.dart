...
class NSKeyValueIvarMutableSet extends Struct {
  /// Allocates a new instance of NSKeyValueIvarMutableSet.
  static Pointer<NSKeyValueIvarMutableSet> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<NSKeyValueIvarMutableSet>(
        'NSKeyValueIvarMutableSet');
  }
}

extension NSKeyValueIvarMutableSetPointer on Pointer<NSKeyValueIvarMutableSet> {
  @ObjcMethodInfo(
    selector: 'addObject:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@'],
