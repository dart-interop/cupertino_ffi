...
class NSKeyValueNotifyingMutableArray extends Struct {
  /// Allocates a new instance of NSKeyValueNotifyingMutableArray.
  static Pointer<NSKeyValueNotifyingMutableArray> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<NSKeyValueNotifyingMutableArray>(
        'NSKeyValueNotifyingMutableArray');
  }
}

extension NSKeyValueNotifyingMutableArrayPointer
    on Pointer<NSKeyValueNotifyingMutableArray> {
  @ObjcMethodInfo(
    selector: 'addObject:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@'],
