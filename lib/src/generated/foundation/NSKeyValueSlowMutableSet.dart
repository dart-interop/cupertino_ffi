...
class NSKeyValueSlowMutableSet extends Struct {
  /// Allocates a new instance of NSKeyValueSlowMutableSet.
  static Pointer<NSKeyValueSlowMutableSet> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<NSKeyValueSlowMutableSet>(
        'NSKeyValueSlowMutableSet');
  }
}

extension NSKeyValueSlowMutableSetPointer on Pointer<NSKeyValueSlowMutableSet> {
  @ObjcMethodInfo(
    selector: 'addObject:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@'],
