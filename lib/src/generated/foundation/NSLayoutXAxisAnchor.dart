...
class NSLayoutXAxisAnchor extends Struct {
  /// Allocates a new instance of NSLayoutXAxisAnchor.
  static Pointer<NSLayoutXAxisAnchor> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc
        .allocateByClassName<NSLayoutXAxisAnchor>('NSLayoutXAxisAnchor');
  }
}

extension NSLayoutXAxisAnchorPointer on Pointer<NSLayoutXAxisAnchor> {
  @ObjcMethodInfo(
