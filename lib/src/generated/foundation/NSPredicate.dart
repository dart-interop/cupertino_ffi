...
class NSPredicate extends Struct {
  /// Allocates a new instance of NSPredicate.
  static Pointer<NSPredicate> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<NSPredicate>('NSPredicate');
  }
}

extension NSPredicatePointer on Pointer<NSPredicate> {
  @ObjcMethodInfo(
  ...
  @ObjcMethodInfo(
    selector: 'predicateByAlsoMatchingNilValueForLeftExpression:modifier:',
    returnType: '@',
    parameterTypes: ['@', ':', '@', 'Q'],
  )
  Pointer predicateByAlsoMatchingNilValueForLeftExpression(
    Pointer arg, {
