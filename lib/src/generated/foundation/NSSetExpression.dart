...
class NSSetExpression extends Struct {
  /// Allocates a new instance of NSSetExpression.
  static Pointer<NSSetExpression> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<NSSetExpression>('NSSetExpression');
  }
}

extension NSSetExpressionPointer on Pointer<NSSetExpression> {
  @ObjcMethodInfo(
  ...
  @ObjcMethodInfo(
    selector: 'initWithType:leftExpression:rightExpression:',
    returnType: '@',
    parameterTypes: ['@', ':', 'Q', '@', '@'],
  )
