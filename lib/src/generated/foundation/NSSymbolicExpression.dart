...
class NSSymbolicExpression extends Struct {
  /// Allocates a new instance of NSSymbolicExpression.
  static Pointer<NSSymbolicExpression> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc
        .allocateByClassName<NSSymbolicExpression>('NSSymbolicExpression');
  }
}

extension NSSymbolicExpressionPointer on Pointer<NSSymbolicExpression> {
  @ObjcMethodInfo(
