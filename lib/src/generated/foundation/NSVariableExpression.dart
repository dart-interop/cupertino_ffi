...
class NSVariableExpression extends Struct {
  /// Allocates a new instance of NSVariableExpression.
  static Pointer<NSVariableExpression> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc
        .allocateByClassName<NSVariableExpression>('NSVariableExpression');
  }
}

extension NSVariableExpressionPointer on Pointer<NSVariableExpression> {
  @ObjcMethodInfo(
