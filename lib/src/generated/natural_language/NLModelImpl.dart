...
class NLModelImpl extends Struct {
  /// Allocates a new instance of NLModelImpl.
  static Pointer<NLModelImpl> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<NLModelImpl>('NLModelImpl');
  }
}

extension NLModelImplPointer on Pointer<NLModelImpl> {
  @ObjcMethodInfo(
