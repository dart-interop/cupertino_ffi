...
class NLModelImplN extends Struct {
  /// Allocates a new instance of NLModelImplN.
  static Pointer<NLModelImplN> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<NLModelImplN>('NLModelImplN');
  }
}

extension NLModelImplNPointer on Pointer<NLModelImplN> {
  @ObjcMethodInfo(
  ...
  @ObjcMethodInfo(
    selector: 'predictedLabelsDictionaryForString:',
    returnType: '@',
    parameterTypes: ['@', ':', '@'],
  )
  Pointer predictedLabelsDictionaryForString(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_returns_ptr(
