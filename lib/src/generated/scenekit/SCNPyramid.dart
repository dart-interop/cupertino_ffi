...
/// Objective-C class _SCNPyramid_.
class SCNPyramid extends Struct {
  /// Allocates a new instance of SCNPyramid.
  static Pointer<SCNPyramid> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<SCNPyramid>('SCNPyramid');
  }
}

extension SCNPyramidPointer on Pointer<SCNPyramid> {
  @ObjcMethodInfo(
    selector: 'copy',
    returnType: '@',
    parameterTypes: ['@', ':'],
  ...
  @ObjcMethodInfo(
    selector: 'presentationPyramid',
    returnType: '@',
    parameterTypes: ['@', ':'],
  )
  Pointer presentationPyramid() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_returns_ptr(
      this,
      _objc.getSelector(
