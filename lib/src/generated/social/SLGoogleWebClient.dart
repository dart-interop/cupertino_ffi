...
/// Objective-C class _SLGoogleWebClient_.
class SLGoogleWebClient extends Struct {
  /// Allocates a new instance of SLGoogleWebClient.
  static Pointer<SLGoogleWebClient> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<SLGoogleWebClient>('SLGoogleWebClient');
  }
}

extension SLGoogleWebClientPointer on Pointer<SLGoogleWebClient> {
  @ObjcMethodInfo(
  ...
  @ObjcMethodInfo(
    selector: 'fallbackUserInfoURL',
    returnType: '@',
    parameterTypes: ['@', ':'],
  )
  Pointer fallbackUserInfoURL() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_returns_ptr(
      this,
      _objc.getSelector(
  ...
  @ObjcMethodInfo(
    selector: 'fallbackWebUserInfoResponseClass',
    returnType: '#',
    parameterTypes: ['@', ':'],
  )
  Pointer fallbackWebUserInfoResponseClass() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_returns_ptr(
      this,
      _objc.getSelector(
