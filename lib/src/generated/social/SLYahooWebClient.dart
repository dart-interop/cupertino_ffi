...
/// Objective-C class _SLYahooWebClient_.
class SLYahooWebClient extends Struct {
  /// Allocates a new instance of SLYahooWebClient.
  static Pointer<SLYahooWebClient> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<SLYahooWebClient>('SLYahooWebClient');
  }
}

extension SLYahooWebClientPointer on Pointer<SLYahooWebClient> {
  @ObjcMethodInfo(
