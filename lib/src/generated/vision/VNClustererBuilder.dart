...
class VNClustererBuilder extends Struct {
  /// Allocates a new instance of VNClustererBuilder.
  static Pointer<VNClustererBuilder> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<VNClustererBuilder>('VNClustererBuilder');
  }
}

extension VNClustererBuilderPointer on Pointer<VNClustererBuilder> {
  @ObjcMethodInfo(
  ...
  @ObjcMethodInfo(
    selector: 'updateModelByAddingFaces:andRemovingFaces:canceller:error:',
    returnType: '@',
    parameterTypes: ['@', ':', '@', '@', '@', '^@'],
  )
  Pointer updateModelByAddingFaces$andRemovingFaces$canceller$error(
    Pointer arg, {
    @required Pointer andRemovingFaces,
    @required Pointer canceller,
    @required Pointer<Pointer> error,
  ...
  Pointer updateModelByAddingFaces$withGroupingIdentifiers$canceller$error(
    Pointer arg, {
    @required Pointer withGroupingIdentifiers,
    @required Pointer canceller,
    @required Pointer<Pointer> error,
