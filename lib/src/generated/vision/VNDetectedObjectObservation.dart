...
class VNDetectedObjectObservation extends Struct {
  /// Allocates a new instance of VNDetectedObjectObservation.
  static Pointer<VNDetectedObjectObservation> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<VNDetectedObjectObservation>(
        'VNDetectedObjectObservation');
  }
}

extension VNDetectedObjectObservationPointer
    on Pointer<VNDetectedObjectObservation> {
  @ObjcMethodInfo(
