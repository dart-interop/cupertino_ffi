...
class VNObservation extends Struct {
  /// Allocates a new instance of VNObservation.
  static Pointer<VNObservation> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<VNObservation>('VNObservation');
  }
}

extension VNObservationPointer on Pointer<VNObservation> {
  @ObjcMethodInfo(
    selector: 'confidence',
    returnType: 'f',
    parameterTypes: ['@', ':'],
