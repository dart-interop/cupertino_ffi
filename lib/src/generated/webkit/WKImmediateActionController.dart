...
/// Objective-C class _WKImmediateActionController_.
class WKImmediateActionController extends Struct {
  /// Allocates a new instance of WKImmediateActionController.
  static Pointer<WKImmediateActionController> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<WKImmediateActionController>(
        'WKImmediateActionController');
  }
}

extension WKImmediateActionControllerPointer
    on Pointer<WKImmediateActionController> {
  @ObjcMethodInfo(
    selector:
        'didPerformImmediateActionHitTest:contentPreventsDefault:userData:',
    returnType: 'v',
    parameterTypes: [
      '@',
      ':',
      '^{WebHitTestResultData={String={RefPtr<WTF::StringImpl, WTF::DumbPtrTraits<WTF::StringImpl> >=^{StringImpl}}}{String={RefPtr<WTF::StringImpl, WTF::DumbPtrTraits<WTF::StringImpl> >=^{StringImpl}}}{String={RefPtr<WTF::StringImpl, WTF::DumbPtrTraits<WTF::StringImpl> >=^{StringImpl}}}{String={RefPtr<WTF::StringImpl, WTF::DumbPtrTraits<WTF::StringImpl> >=^{StringImpl}}}{String={RefPtr<WTF::StringImpl, WTF::DumbPtrTraits<WTF::StringImpl> >=^{StringImpl}}}{String={RefPtr<WTF::StringImpl, WTF::DumbPtrTraits<WTF::StringImpl> >=^{StringImpl}}}{String={RefPtr<WTF::StringImpl, WTF::DumbPtrTraits<WTF::StringImpl> >=^{StringImpl}}}B{IntRect={IntPoint=ii}{IntSize=ii}}BBBBB{String={RefPtr<WTF::StringImpl, WTF::DumbPtrTraits<WTF::StringImpl> >=^{StringImpl}}}{RefPtr<WebKit::SharedMemory, WTF::DumbPtrTraits<WebKit::SharedMemory> >=^{SharedMemory}}Q{RetainPtr<DDActionContext>=^v}{FloatRect={FloatPoint=ff}{FloatSize=ff}}{RefPtr<WebCore::TextIndicator, WTF::DumbPtrTraits<WebCore::TextIndicator> >=^{TextIndicator}}Q{DictionaryPopupInfo={FloatPoint=ff}{TextIndicatorData={FloatRect={FloatPoint=ff}{FloatSize=ff}}{FloatRect={FloatPoint=ff}{FloatSize=ff}}{FloatRect={FloatPoint=ff}{FloatSize=ff}}{Vector<WebCore::FloatRect, 0, WTF::CrashOnOverflow, 16>=^{FloatRect}II}f{RefPtr<WebCore::Image, WTF::DumbPtrTraits<WebCore::Image> >=^{Image}}{RefPtr<WebCore::Image, WTF::DumbPtrTraits<WebCore::Image> >=^{Image}}{RefPtr<WebCore::Image, WTF::DumbPtrTraits<WebCore::Image> >=^{Image}}{Color=(?=Q^{ExtendedColor})}CS}{RetainPtr<NSDictionary>=^v}{RetainPtr<NSAttributedString>=^v}}{RefPtr<WebCore::TextIndicator, WTF::DumbPtrTraits<WebCore::TextIndicator> >=^{TextIndicator}}}',
      'c',
      '^{Object=^^?@}'
    ],
  )
  Pointer didPerformImmediateActionHitTest(
    Pointer arg, {
    @required int contentPreventsDefault,
    ...
    return _objc_call.call_ptr_ptr_ptr_int8_ptr_returns_ptr(
      ...
      arg,
      contentPreventsDefault,
      userData,
    );
  }

  @ObjcMethodInfo(
    selector: 'dismissContentRelativeChildWindows',
    returnType: 'v',
    parameterTypes: ['@', ':'],
  )
  Pointer dismissContentRelativeChildWindows() {
    _ensureDynamicLibraryHasBeenOpened();
  ...
  @ObjcMethodInfo(
    selector: 'hasActiveImmediateAction',
    returnType: 'c',
    parameterTypes: ['@', ':'],
  )
  int hasActiveImmediateAction() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_returns_int8(
      this,
      _objc.getSelector(
        'hasActiveImmediateAction',
      ),
    );
  }

  @ObjcMethodInfo(
    selector: 'immediateActionRecognizerDidCancelAnimation:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@'],
  )
  Pointer immediateActionRecognizerDidCancelAnimation(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
  ...
  @ObjcMethodInfo(
    selector: 'immediateActionRecognizerDidCompleteAnimation:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@'],
  )
  Pointer immediateActionRecognizerDidCompleteAnimation(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_returns_ptr(
  ...
  @ObjcMethodInfo(
    selector: 'immediateActionRecognizerDidUpdateAnimation:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@'],
  )
  Pointer immediateActionRecognizerDidUpdateAnimation(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_returns_ptr(
  ...
  @ObjcMethodInfo(
    selector: 'immediateActionRecognizerWillBeginAnimation:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@'],
  )
  Pointer immediateActionRecognizerWillBeginAnimation(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_returns_ptr(
  ...
  @ObjcMethodInfo(
    selector: 'immediateActionRecognizerWillPrepare:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@'],
  )
  Pointer immediateActionRecognizerWillPrepare(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_returns_ptr(
  ...
  @ObjcMethodInfo(
    selector: 'initWithPage:view:viewImpl:recognizer:',
    returnType: '@',
    parameterTypes: [
      '@',
      ':',
  ...
  Pointer initWithPage(
    ...
    @required Pointer recognizer,
  }) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_ptr_ptr_ptr_returns_ptr(
      this,
      _objc.getSelector(
        'initWithPage:view:viewImpl:recognizer:',
      ),
      arg,
      view,
      viewImpl,
  ...
  @ObjcMethodInfo(
    selector: 'menuItemDidClose:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@'],
  )
  Pointer menuItemDidClose(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_returns_ptr(
