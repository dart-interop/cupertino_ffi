...
/// Objective-C class _WKInspectorViewController_.
class WKInspectorViewController extends Struct {
  /// Allocates a new instance of WKInspectorViewController.
  static Pointer<WKInspectorViewController> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<WKInspectorViewController>(
        'WKInspectorViewController');
  }
}

extension WKInspectorViewControllerPointer
    on Pointer<WKInspectorViewController> {
  @ObjcMethodInfo(
  ...
  @ObjcMethodInfo(
    selector: 'initWithInspectedPage:',
    returnType: '@',
    parameterTypes: [
      '@',
      ':',
  ...
  @ObjcMethodInfo(
    selector: 'inspectorWKWebView:willMoveToWindow:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@', '@'],
  )
  Pointer inspectorWKWebView(
    Pointer arg, {
    ...
    return _objc_call.call_ptr_ptr_ptr_ptr_returns_ptr(
      this,
      _objc.getSelector(
        'inspectorWKWebView:willMoveToWindow:',
      ),
      arg,
      willMoveToWindow,
    );
  ...
  @ObjcMethodInfo(
    selector: 'inspectorWKWebViewDidMoveToWindow:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@'],
  )
  Pointer inspectorWKWebViewDidMoveToWindow(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_returns_ptr(
      this,
      _objc.getSelector(
        'inspectorWKWebViewDidMoveToWindow:',
      ),
      arg,
    );
  }
  ...
  @ObjcMethodInfo(
    selector: 'inspectorWKWebViewReload:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@'],
  )
  Pointer inspectorWKWebViewReload(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_returns_ptr(
  ...
  @ObjcMethodInfo(
    selector: 'inspectorWKWebViewReloadFromOrigin:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@'],
  )
  Pointer inspectorWKWebViewReloadFromOrigin(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_returns_ptr(
  ...
  Pointer webView$runOpenPanelWithParameters$initiatedByFrame$completionHandler(
    Pointer arg, {
  ...
  Pointer webViewWebContentProcessDidTerminate(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_returns_ptr(
