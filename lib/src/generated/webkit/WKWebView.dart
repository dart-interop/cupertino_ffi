...
/// Objective-C class _WKWebView_.
class WKWebView extends Struct {
  /// Allocates a new instance of WKWebView.
  static Pointer<WKWebView> allocate() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc.allocateByClassName<WKWebView>('WKWebView');
  }
}

extension WKWebViewPointer on Pointer<WKWebView> {
  @ObjcMethodInfo(
    selector: 'UIDelegate',
    returnType: '@',
    parameterTypes: ['@', ':'],
  ...
  @ObjcMethodInfo(
    selector: 'documentContainerView',
    returnType: '@',
    parameterTypes: ['@', ':'],
  )
  Pointer documentContainerView() {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_returns_ptr(
      this,
      _objc.getSelector(
  ...
  @ObjcMethodInfo(
    selector: 'shareSheetDidDismiss:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@'],
  )
  Pointer shareSheetDidDismiss(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_returns_ptr(
  ...
  Pointer takeSnapshotWithConfiguration(
    Pointer arg, {
    @required Pointer completionHandler,
  }) {
    _ensureDynamicLibraryHasBeenOpened();
  ...
  @ObjcMethodInfo(
    selector: 'typingAttributesWithCompletionHandler:',
    returnType: 'v',
    parameterTypes: ['@', ':', '@?'],
  )
  Pointer typingAttributesWithCompletionHandler(
    Pointer arg,
  ) {
    _ensureDynamicLibraryHasBeenOpened();
    return _objc_call.call_ptr_ptr_ptr_returns_ptr(
      this,
      _objc.getSelector(
        'typingAttributesWithCompletionHandler:',
      ),
      arg,
    );
  }
