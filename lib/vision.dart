...
class BurstFaceScoreEntry extends Struct<BurstFaceScoreEntry> {
  ...
  static Pointer initWithScore(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_float32_returns_ptr(
      _self,
...
class BurstImageStat extends Struct<BurstImageStat> {
  ...
  static double computeScore(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_float32_returns_float32(
      _self,
...
class BurstThumbnailCluster extends Struct<BurstThumbnailCluster> {
  ...
  static double computeMergeCost(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_ptr_Int32_returns_float32(
      _self,
...
class CCCharBoxContext extends Struct<CCCharBoxContext> {
  ...
  static int checkFlag(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Uint64_Uint32_returns_Uint32(
      _self,
  ...
  static void clearFlag(
    ...
    _openDynamicLibrary();
    _call_ptr_ptr_Uint64_Uint32_returns_void(
      _self,
  ...
  static void copyFlagValue(
    ...
    _openDynamicLibrary();
    _call_ptr_ptr_Uint64_Uint64_Uint32_returns_void(
      _self,
  ...
  static int loopBigBox(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_returns_Int16(
      _self,
  ...
  static void setLoopBigBox(
    ...
    _openDynamicLibrary();
    _call_ptr_ptr_Int16_returns_void(
      _self,
...
class CCTextDetector extends Struct<CCTextDetector> {
  ...
  static int computeNumCropCols(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_Uint64_ptr_returns_Uint16(
      _self,
  ...
  static int computePulseVectorSum(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_Uint16_Uint16_Uint64_Uint64_Uint16_Uint16_returns_Int32(
      _self,
      _objc.getSelector(
  ...
  static void generateDominantPulse(
    ...
    _openDynamicLibrary();
    _call_ptr_ptr_Uint64_ptr_Uint8_Uint16_Uint16_returns_void(
      _self,
      _objc.getSelector(
...
class CVMLImageprintObservation_LegacySupportDoNotChange
  ...
  static int serializeStateIntoData(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_Uint64_ptr_returns_Uint64(
      _self,
...
class LKTGPU extends Struct<LKTGPU> {
  ...
  static Pointer initWithMetalContext(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_Int32_Int32_Int32_ptr_returns_ptr(
      _self,
...
class LKTMetalContext extends Struct<LKTMetalContext> {
  ...
  static int textureBytesPerRow(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Uint64_Uint64_returns_Uint64(
      _self,
...
class SaliencyExtrema extends Struct<SaliencyExtrema> {
  ...
  static void updateExtrema(
    ...
    _openDynamicLibrary();
    _call_ptr_ptr_float32_Int32_Int32_returns_void(
      _self,
...
class ShotflowDetector extends Struct<ShotflowDetector> {
  ...
  static Pointer initWithNetwork(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_float32_returns_ptr(
      _self,
  ...
  static Pointer processBoxes(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_float32_float32_returns_ptr(
      _self,
...
class ShotflowFaceDetection extends Struct<ShotflowFaceDetection> {
  ...
  static Pointer isOverlappingLowMergeDet(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_float32_Int32_returns_ptr(
      _self,
      _objc.getSelector(
...
class ShotflowNetwork extends Struct<ShotflowNetwork> {
  ...
  static Pointer initWithModelPath(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_Int32_Int32_Int32_float32_returns_ptr(
      _self,
      _objc.getSelector(
  ...
  static int setInputShape(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Uint64_Uint64_returns_Int32(
      _self,
...
class VNAlignFaceRectangleRequest extends Struct<VNAlignFaceRectangleRequest> {
  ...
  static int internalPerformRevision(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Uint64_ptr_ptr_returns_Int8(
      _self,
...
class VNClassificationObservation extends Struct<VNClassificationObservation> {
  ...
  static Pointer initWithRequestRevision(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Uint64_ptr_float32_returns_ptr(
      _self,
...
class VNClustererBuilder extends Struct<VNClustererBuilder> {
  ...
  static Pointer initWithType$cachePath$state$threshold$error(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_ptr_ptr_float32_ptr_returns_ptr(
      _self,
  ...
  static Pointer initWithType$cachePath$state$threshold$torsoThreshold$error(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_ptr_ptr_float32_float32_ptr_returns_ptr(
      _self,
      _objc.getSelector(
  ...
  static Pointer suggestionsForClustersWithFaceIds(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_float32_ptr_ptr_returns_ptr(
      _self,
      _objc.getSelector(
...
class VNClustererBuilderOptions extends Struct<VNClustererBuilderOptions> {
  ...
  static Pointer initWithType$cachePath$state$threshold(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_ptr_ptr_float32_returns_ptr(
      _self,
  ...
  static Pointer initWithType$cachePath$state$threshold$torsoThreshold(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_ptr_ptr_float32_float32_returns_ptr(
      _self,
      _objc.getSelector(
...
class VNClustererContextBase extends Struct<VNClustererContextBase> {
  ...
  static Pointer initWithType$cachePath$state$readOnly$threshold$error(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_ptr_ptr_Int8_float32_ptr_returns_ptr(
      _self,
      _objc.getSelector(
  ...
  static Pointer
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_ptr_ptr_Int8_float32_float32_ptr_returns_ptr(
      _self,
      _objc.getSelector(
          "initWithType:cachePath:state:readOnly:threshold:torsoThreshold:error:"),
      arg,
...
class VNEspressoFaceDetectedObject
  ...
  static Pointer initWithOptionsXloc(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_float32_float32_float32_float32_returns_ptr(
      _self,
...
class VNEspressoModelImageprint extends Struct<VNEspressoModelImageprint> {
  ...
  static Pointer initWithData(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_Uint64_Uint64_ptr_Uint64_returns_ptr(
      _self,
      _objc.getSelector(
...
class VNFaceLandmarkRegion2D extends Struct<VNFaceLandmarkRegion2D> {
  ...
  static int pointAtIndex(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Uint64_returns_Uint8(
      _self,
...
class VNFaceLandmarkSegments extends Struct<VNFaceLandmarkSegments> {
  ...
  static Pointer initWithRequestRevision(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Uint64_Uint64_Uint64_Uint64_ptr_returns_ptr(
      _self,
      _objc.getSelector(
...
class VNGreedyClusteringReadOnly extends Struct<VNGreedyClusteringReadOnly> {
  ...
  static Pointer suggestionsForClusterIdsWithFlags(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_float32_ptr_returns_ptr(
      _self,
      _objc.getSelector(
...
class VNImageAestheticsObservation
  ...
  static Pointer initWithRequestRevision(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Uint64_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_returns_ptr(
      _self,
      _objc.getSelector(
...
class VNImageBasedRequest extends Struct<VNImageBasedRequest> {
  ...
  static Pointer validatedInputFaceObservationsClippedToRegionOfInterest(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Int8_ptr_returns_ptr(
      _self,
      _objc.getSelector(
...
class VNImageBuffer extends Struct<VNImageBuffer> {
  ...
  static Pointer augmentedBuffersWithWidth(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Uint64_Uint64_Uint32_ptr_ptr_ptr_returns_ptr(
      _self,
      _objc.getSelector(
...
class VNImageRequestHandler extends Struct<VNImageRequestHandler> {
  ...
  static Pointer initWithCIImage$orientation$options(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_Uint32_ptr_returns_ptr(
      _self,
...
class VNImageprint extends Struct<VNImageprint> {
  ...
  static Pointer initWithImageDescriptor(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_Uint64_Uint64_returns_ptr(
      _self,
...
class VNMPImageDescriptor extends Struct<VNMPImageDescriptor> {
  ...
  static double computeFinalDescriptorBasedDistanceForColorDistance(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_float32_float32_returns_float32(
      _self,
      _objc.getSelector(
...
class VNMomentProcessor extends Struct<VNMomentProcessor> {
  ...
  static Pointer computeClusteringForClusteringTree$intoKGroups$error(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_Int32_ptr_returns_ptr(
      _self,
      _objc
...
class VNPersonsModelData extends Struct<VNPersonsModelData> {
  ...
  static int faceModelNumberOfFaceObservationsForPersonAtIndex(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Uint64_returns_Uint64(
      _self,
...
class VNPersonsModelPrediction extends Struct<VNPersonsModelPrediction> {
  ...
  static Pointer initWithFaceObservation(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_ptr_float32_returns_ptr(
      _self,
      _objc.getSelector(
...
class VNRequestPerformingContext extends Struct<VNRequestPerformingContext> {
  ...
  static Pointer
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_ptr_ptr_ptr_Uint32_returns_ptr(
      _self,
      _objc.getSelector(
          "initWithRequestPerformer:imageBuffer:forensics:observationsCache:qosClass:"),
      arg,
...
class VNSequenceRequestHandler extends Struct<VNSequenceRequestHandler> {
  ...
  static int performRequests$onCIImage$orientation$error(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_ptr_Uint32_ptr_returns_Int8(
      _self,
  ...
  static int performRequests$onCIImage$orientation$gatheredForensics$error(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_ptr_Uint32_ptr_ptr_returns_Int8(
      _self,
      _objc.getSelector(
...
class VNSizeRange extends Struct<VNSizeRange> {
  ...
  static Pointer initWithMinimumDimension(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Uint64_Uint64_Uint64_returns_ptr(
      _self,
      _objc.getSelector(
...
class VNSupportedImageSize extends Struct<VNSupportedImageSize> {
  ...
  static Pointer initWithIdealFormat(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Uint32_ptr_ptr_Uint64_Uint32_Int8_returns_ptr(
      _self,
      _objc.getSelector(
  ...
  static int isAllowedPixelsWide(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_Uint64_Uint64_returns_Int8(
      _self,
...
class VNTargetedImageRequest extends Struct<VNTargetedImageRequest> {
  ...
  static Pointer initWithTargetedCIImage$orientation$options$completionHandler(
    ...
    _openDynamicLibrary();
    return _call_ptr_ptr_ptr_Uint32_ptr_ptr_returns_ptr(
      _self,
      _objc.getSelector(
  ...
  static Pointer initWithTargetedImageURL$orientation$options$completionHandler(
    Pointer<VNTargetedImageRequest> _self,
    Pointer arg, {
    @required int orientation,
    @required Pointer options,
...
final _call_ptr_ptr_Int16_returns_void = _objc.dlForObjectiveC.lookupFunction<
    _call_ptr_ptr_Int16_returns_void_C,
    _call_ptr_ptr_Int16_returns_void_Dart>("objc_msgSend");
typedef _call_ptr_ptr_Int16_returns_void_C = Void Function(
    Pointer _arg0, Pointer _arg1, Int16 arg);
typedef _call_ptr_ptr_Int16_returns_void_Dart = void Function(
...
final _call_ptr_ptr_Int8_ptr_returns_ptr = _objc.dlForObjectiveC.lookupFunction<
    _call_ptr_ptr_Int8_ptr_returns_ptr_C,
    _call_ptr_ptr_Int8_ptr_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_Int8_ptr_returns_ptr_C = Pointer Function(
    Pointer _arg0, Pointer _arg1, Int8 arg, Pointer error);
typedef _call_ptr_ptr_Int8_ptr_returns_ptr_Dart = Pointer Function(
...
final _call_ptr_ptr_Uint32_ptr_ptr_Uint64_Uint32_Int8_returns_ptr =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_Uint32_ptr_ptr_Uint64_Uint32_Int8_returns_ptr_C,
            _call_ptr_ptr_Uint32_ptr_ptr_Uint64_Uint32_Int8_returns_ptr_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_Uint32_ptr_ptr_Uint64_Uint32_Int8_returns_ptr_C
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Uint32 arg,
...
typedef _call_ptr_ptr_Uint32_ptr_ptr_Uint64_Uint32_Int8_returns_ptr_Dart
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        int arg,
...
final _call_ptr_ptr_Uint64_Uint32_returns_Uint32 = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_Uint64_Uint32_returns_Uint32_C,
        _call_ptr_ptr_Uint64_Uint32_returns_Uint32_Dart>("objc_msgSend");
typedef _call_ptr_ptr_Uint64_Uint32_returns_Uint32_C = Uint32 Function(
    Pointer _arg0, Pointer _arg1, Uint64 arg, Uint32 atIndex);
typedef _call_ptr_ptr_Uint64_Uint32_returns_Uint32_Dart = int Function(
    Pointer _arg0, Pointer _arg1, int arg, int atIndex);

final _call_ptr_ptr_Uint64_Uint32_returns_void = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_Uint64_Uint32_returns_void_C,
        _call_ptr_ptr_Uint64_Uint32_returns_void_Dart>("objc_msgSend");
typedef _call_ptr_ptr_Uint64_Uint32_returns_void_C = Void Function(
    Pointer _arg0, Pointer _arg1, Uint64 arg, Uint32 atIndex);
typedef _call_ptr_ptr_Uint64_Uint32_returns_void_Dart = void Function(
    Pointer _arg0, Pointer _arg1, int arg, int atIndex);

final _call_ptr_ptr_Uint64_Uint64_Uint32_ptr_ptr_ptr_returns_ptr =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_Uint64_Uint64_Uint32_ptr_ptr_ptr_returns_ptr_C,
            _call_ptr_ptr_Uint64_Uint64_Uint32_ptr_ptr_ptr_returns_ptr_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_Uint64_Uint64_Uint32_ptr_ptr_ptr_returns_ptr_C
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Uint64 arg,
        ...
        Pointer error);
typedef _call_ptr_ptr_Uint64_Uint64_Uint32_ptr_ptr_ptr_returns_ptr_Dart
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        int arg,
...
final _call_ptr_ptr_Uint64_Uint64_Uint32_returns_void = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_Uint64_Uint64_Uint32_returns_void_C,
        _call_ptr_ptr_Uint64_Uint64_Uint32_returns_void_Dart>("objc_msgSend");
typedef _call_ptr_ptr_Uint64_Uint64_Uint32_returns_void_C = Void Function(
    Pointer _arg0, Pointer _arg1, Uint64 arg, Uint64 toTarget, Uint32 atIndex);
typedef _call_ptr_ptr_Uint64_Uint64_Uint32_returns_void_Dart = void Function(
    Pointer _arg0, Pointer _arg1, int arg, int toTarget, int atIndex);

final _call_ptr_ptr_Uint64_Uint64_Uint64_Uint64_ptr_returns_ptr =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_Uint64_Uint64_Uint64_Uint64_ptr_returns_ptr_C,
            _call_ptr_ptr_Uint64_Uint64_Uint64_Uint64_ptr_returns_ptr_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_Uint64_Uint64_Uint64_Uint64_ptr_returns_ptr_C
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Uint64 arg,
...
typedef _call_ptr_ptr_Uint64_Uint64_Uint64_Uint64_ptr_returns_ptr_Dart
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        int arg,
...
final _call_ptr_ptr_Uint64_Uint64_Uint64_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_Uint64_Uint64_Uint64_returns_ptr_C,
        _call_ptr_ptr_Uint64_Uint64_Uint64_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_Uint64_Uint64_Uint64_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Uint64 arg,
    Uint64 maximumDimension,
    Uint64 idealDimension);
typedef _call_ptr_ptr_Uint64_Uint64_Uint64_returns_ptr_Dart = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    int arg,
...
final _call_ptr_ptr_Uint64_Uint64_returns_Int32 = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_Uint64_Uint64_returns_Int32_C,
        _call_ptr_ptr_Uint64_Uint64_returns_Int32_Dart>("objc_msgSend");
typedef _call_ptr_ptr_Uint64_Uint64_returns_Int32_C = Int32 Function(
    Pointer _arg0, Pointer _arg1, Uint64 arg, Uint64 height);
typedef _call_ptr_ptr_Uint64_Uint64_returns_Int32_Dart = int Function(
    Pointer _arg0, Pointer _arg1, int arg, int height);

final _call_ptr_ptr_Uint64_Uint64_returns_Int8 = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_Uint64_Uint64_returns_Int8_C,
        _call_ptr_ptr_Uint64_Uint64_returns_Int8_Dart>("objc_msgSend");
typedef _call_ptr_ptr_Uint64_Uint64_returns_Int8_C = Int8 Function(
    Pointer _arg0, Pointer _arg1, Uint64 arg, Uint64 pixelsHigh);
typedef _call_ptr_ptr_Uint64_Uint64_returns_Int8_Dart = int Function(
    Pointer _arg0, Pointer _arg1, int arg, int pixelsHigh);

final _call_ptr_ptr_Uint64_Uint64_returns_Uint64 = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_Uint64_Uint64_returns_Uint64_C,
        _call_ptr_ptr_Uint64_Uint64_returns_Uint64_Dart>("objc_msgSend");
typedef _call_ptr_ptr_Uint64_Uint64_returns_Uint64_C = Uint64 Function(
    Pointer _arg0, Pointer _arg1, Uint64 arg, Uint64 format);
typedef _call_ptr_ptr_Uint64_Uint64_returns_Uint64_Dart = int Function(
...
final _call_ptr_ptr_Uint64_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_returns_ptr =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_Uint64_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_returns_ptr_C,
            _call_ptr_ptr_Uint64_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_returns_ptr_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_Uint64_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_returns_ptr_C
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Uint64 arg,
...
typedef _call_ptr_ptr_Uint64_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_float32_returns_ptr_Dart
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        int arg,
...
final _call_ptr_ptr_Uint64_ptr_Uint8_Uint16_Uint16_returns_void =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_Uint64_ptr_Uint8_Uint16_Uint16_returns_void_C,
            _call_ptr_ptr_Uint64_ptr_Uint8_Uint16_Uint16_returns_void_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_Uint64_ptr_Uint8_Uint16_Uint16_returns_void_C
    = Void Function(
        Pointer _arg0,
        Pointer _arg1,
        Uint64 arg,
        ...
        Uint16 bufferHeight,
        Uint16 bufferWidth);
typedef _call_ptr_ptr_Uint64_ptr_Uint8_Uint16_Uint16_returns_void_Dart
    = void Function(
        Pointer _arg0,
        Pointer _arg1,
        int arg,
...
final _call_ptr_ptr_Uint64_ptr_float32_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_Uint64_ptr_float32_returns_ptr_C,
        _call_ptr_ptr_Uint64_ptr_float32_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_Uint64_ptr_float32_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Uint64 arg,
    Pointer identifier,
    Float confidence);
typedef _call_ptr_ptr_Uint64_ptr_float32_returns_ptr_Dart = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    int arg,
    Pointer identifier,
...
final _call_ptr_ptr_Uint64_ptr_ptr_returns_Int8 = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_Uint64_ptr_ptr_returns_Int8_C,
        _call_ptr_ptr_Uint64_ptr_ptr_returns_Int8_Dart>("objc_msgSend");
typedef _call_ptr_ptr_Uint64_ptr_ptr_returns_Int8_C = Int8 Function(
    Pointer _arg0, Pointer _arg1, Uint64 arg, Pointer inContext, Pointer error);
typedef _call_ptr_ptr_Uint64_ptr_ptr_returns_Int8_Dart = int Function(
...
final _call_ptr_ptr_Uint64_returns_Uint64 = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_Uint64_returns_Uint64_C,
        _call_ptr_ptr_Uint64_returns_Uint64_Dart>("objc_msgSend");
typedef _call_ptr_ptr_Uint64_returns_Uint64_C = Uint64 Function(
    Pointer _arg0, Pointer _arg1, Uint64 arg);
typedef _call_ptr_ptr_Uint64_returns_Uint64_Dart = int Function(
    Pointer _arg0, Pointer _arg1, int arg);

final _call_ptr_ptr_Uint64_returns_Uint8 = _objc.dlForObjectiveC.lookupFunction<
    _call_ptr_ptr_Uint64_returns_Uint8_C,
    _call_ptr_ptr_Uint64_returns_Uint8_Dart>("objc_msgSend");
typedef _call_ptr_ptr_Uint64_returns_Uint8_C = Uint8 Function(
    Pointer _arg0, Pointer _arg1, Uint64 arg);
typedef _call_ptr_ptr_Uint64_returns_Uint8_Dart = int Function(
    Pointer _arg0, Pointer _arg1, int arg);
...
final _call_ptr_ptr_float32_Int32_Int32_returns_void = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_float32_Int32_Int32_returns_void_C,
        _call_ptr_ptr_float32_Int32_Int32_returns_void_Dart>("objc_msgSend");
typedef _call_ptr_ptr_float32_Int32_Int32_returns_void_C = Void Function(
    Pointer _arg0, Pointer _arg1, Float arg, Int32 x, Int32 y);
typedef _call_ptr_ptr_float32_Int32_Int32_returns_void_Dart = void Function(
    Pointer _arg0, Pointer _arg1, double arg, int x, int y);

final _call_ptr_ptr_float32_float32_float32_float32_returns_ptr =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_float32_float32_float32_float32_returns_ptr_C,
            _call_ptr_ptr_float32_float32_float32_float32_returns_ptr_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_float32_float32_float32_float32_returns_ptr_C
    = Pointer Function(Pointer _arg0, Pointer _arg1, Float arg, Float yloc,
        Float size, Float confidence);
typedef _call_ptr_ptr_float32_float32_float32_float32_returns_ptr_Dart
    = Pointer Function(Pointer _arg0, Pointer _arg1, double arg, double yloc,
        double size, double confidence);

final _call_ptr_ptr_float32_float32_returns_float32 = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_float32_float32_returns_float32_C,
        _call_ptr_ptr_float32_float32_returns_float32_Dart>("objc_msgSend");
typedef _call_ptr_ptr_float32_float32_returns_float32_C = Float Function(
    Pointer _arg0, Pointer _arg1, Float arg, Float andSceneClassifierDistance);
typedef _call_ptr_ptr_float32_float32_returns_float32_Dart = double Function(
    Pointer _arg0,
    Pointer _arg1,
    double arg,
    double andSceneClassifierDistance);

final _call_ptr_ptr_float32_returns_float32 = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_float32_returns_float32_C,
        _call_ptr_ptr_float32_returns_float32_Dart>("objc_msgSend");
typedef _call_ptr_ptr_float32_returns_float32_C = Float Function(
    Pointer _arg0, Pointer _arg1, Float arg);
typedef _call_ptr_ptr_float32_returns_float32_Dart = double Function(
    Pointer _arg0, Pointer _arg1, double arg);

final _call_ptr_ptr_float32_returns_ptr = _objc.dlForObjectiveC.lookupFunction<
    _call_ptr_ptr_float32_returns_ptr_C,
    _call_ptr_ptr_float32_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_float32_returns_ptr_C = Pointer Function(
    Pointer _arg0, Pointer _arg1, Float arg);
typedef _call_ptr_ptr_float32_returns_ptr_Dart = Pointer Function(
    Pointer _arg0, Pointer _arg1, double arg);
...
final _call_ptr_ptr_ptr_Int32_Int32_Int32_float32_returns_ptr =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_ptr_Int32_Int32_Int32_float32_returns_ptr_C,
            _call_ptr_ptr_ptr_Int32_Int32_Int32_float32_returns_ptr_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_ptr_Int32_Int32_Int32_float32_returns_ptr_C
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
        ...
        Float threshold);
typedef _call_ptr_ptr_ptr_Int32_Int32_Int32_float32_returns_ptr_Dart
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
...
final _call_ptr_ptr_ptr_Int32_Int32_Int32_ptr_returns_ptr =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_ptr_Int32_Int32_Int32_ptr_returns_ptr_C,
            _call_ptr_ptr_ptr_Int32_Int32_Int32_ptr_returns_ptr_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_ptr_Int32_Int32_Int32_ptr_returns_ptr_C
    = Pointer Function(Pointer _arg0, Pointer _arg1, Pointer arg, Int32 width,
        Int32 height, Int32 nscales, Pointer error);
typedef _call_ptr_ptr_ptr_Int32_Int32_Int32_ptr_returns_ptr_Dart
    = Pointer Function(Pointer _arg0, Pointer _arg1, Pointer arg, int width,
        int height, int nscales, Pointer error);

final _call_ptr_ptr_ptr_Int32_ptr_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_Int32_ptr_returns_ptr_C,
        _call_ptr_ptr_ptr_Int32_ptr_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_Int32_ptr_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Int32 intoKGroups,
    Pointer error);
typedef _call_ptr_ptr_ptr_Int32_ptr_returns_ptr_Dart = Pointer Function(
...
final _call_ptr_ptr_ptr_Uint16_Uint16_Uint64_Uint64_Uint16_Uint16_returns_Int32 =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_ptr_Uint16_Uint16_Uint64_Uint64_Uint16_Uint16_returns_Int32_C,
            _call_ptr_ptr_ptr_Uint16_Uint16_Uint64_Uint64_Uint16_Uint16_returns_Int32_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_ptr_Uint16_Uint16_Uint64_Uint64_Uint16_Uint16_returns_Int32_C
    = Int32 Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
        ...
        Uint16 bottomHeight,
        Uint16 topHeight);
typedef _call_ptr_ptr_ptr_Uint16_Uint16_Uint64_Uint64_Uint16_Uint16_returns_Int32_Dart
    = int Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
...
final _call_ptr_ptr_ptr_Uint32_ptr_ptr_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_Uint32_ptr_ptr_returns_ptr_C,
        _call_ptr_ptr_ptr_Uint32_ptr_ptr_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_Uint32_ptr_ptr_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Uint32 orientation,
...
typedef _call_ptr_ptr_ptr_Uint32_ptr_ptr_returns_ptr_Dart = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    int orientation,
...
final _call_ptr_ptr_ptr_Uint32_ptr_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_Uint32_ptr_returns_ptr_C,
        _call_ptr_ptr_ptr_Uint32_ptr_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_Uint32_ptr_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Uint32 orientation,
    Pointer options);
typedef _call_ptr_ptr_ptr_Uint32_ptr_returns_ptr_Dart = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    int orientation,
...
final _call_ptr_ptr_ptr_Uint64_Uint64_ptr_Uint64_returns_ptr =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_ptr_Uint64_Uint64_ptr_Uint64_returns_ptr_C,
            _call_ptr_ptr_ptr_Uint64_Uint64_ptr_Uint64_returns_ptr_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_ptr_Uint64_Uint64_ptr_Uint64_returns_ptr_C
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
...
typedef _call_ptr_ptr_ptr_Uint64_Uint64_ptr_Uint64_returns_ptr_Dart
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
...
final _call_ptr_ptr_ptr_Uint64_Uint64_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_Uint64_Uint64_returns_ptr_C,
        _call_ptr_ptr_ptr_Uint64_Uint64_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_Uint64_Uint64_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Uint64 faceObservationAtIndex,
    Uint64 forPersonAtIndex);
typedef _call_ptr_ptr_ptr_Uint64_Uint64_returns_ptr_Dart = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
...
final _call_ptr_ptr_ptr_Uint64_ptr_returns_Uint16 = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_Uint64_ptr_returns_Uint16_C,
        _call_ptr_ptr_ptr_Uint64_ptr_returns_Uint16_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_Uint64_ptr_returns_Uint16_C = Uint16 Function(
    Pointer _arg0, Pointer _arg1, Pointer arg, Uint64 width, Pointer start);
typedef _call_ptr_ptr_ptr_Uint64_ptr_returns_Uint16_Dart = int Function(
    Pointer _arg0, Pointer _arg1, Pointer arg, int width, Pointer start);

final _call_ptr_ptr_ptr_Uint64_ptr_returns_Uint64 = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_Uint64_ptr_returns_Uint64_C,
        _call_ptr_ptr_ptr_Uint64_ptr_returns_Uint64_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_Uint64_ptr_returns_Uint64_C = Uint64 Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Uint64 startingAtByteOffset,
    Pointer error);
typedef _call_ptr_ptr_ptr_Uint64_ptr_returns_Uint64_Dart = int Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
...
typedef _call_ptr_ptr_ptr_Uint64_returns_ptr_C = Pointer Function(Pointer _arg0,
...
typedef _call_ptr_ptr_ptr_Uint64_returns_ptr_Dart = Pointer Function(
    ...
    Pointer _arg1,
    Pointer arg,
    int uniqueIdentifierOfPersonAtIndex);

final _call_ptr_ptr_ptr_float32_Int32_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_float32_Int32_returns_ptr_C,
        _call_ptr_ptr_ptr_float32_Int32_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_float32_Int32_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Float withOverlapThreshold,
    Int32 withMergeCountDelta);
typedef _call_ptr_ptr_ptr_float32_Int32_returns_ptr_Dart = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
...
final _call_ptr_ptr_ptr_float32_float32_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_float32_float32_returns_ptr_C,
        _call_ptr_ptr_ptr_float32_float32_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_float32_float32_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Float withOverlapThreshold,
    Float withSizeRatio);
typedef _call_ptr_ptr_ptr_float32_float32_returns_ptr_Dart = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    double withOverlapThreshold,
...
final _call_ptr_ptr_ptr_float32_ptr_ptr_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_float32_ptr_ptr_returns_ptr_C,
        _call_ptr_ptr_ptr_float32_ptr_ptr_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_float32_ptr_ptr_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    ...
    Pointer context,
    Pointer error);
typedef _call_ptr_ptr_ptr_float32_ptr_ptr_returns_ptr_Dart = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
...
final _call_ptr_ptr_ptr_float32_ptr_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_float32_ptr_returns_ptr_C,
        _call_ptr_ptr_ptr_float32_ptr_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_float32_ptr_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Float usingThreshold,
    Pointer error);
typedef _call_ptr_ptr_ptr_float32_ptr_returns_ptr_Dart = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
...
final _call_ptr_ptr_ptr_float32_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_float32_returns_ptr_C,
        _call_ptr_ptr_ptr_float32_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_float32_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Float clusteringDistanceThreshold);
typedef _call_ptr_ptr_ptr_float32_returns_ptr_Dart = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    double clusteringDistanceThreshold);

final _call_ptr_ptr_ptr_ptr_Int32_returns_float32 = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_ptr_Int32_returns_float32_C,
        _call_ptr_ptr_ptr_ptr_Int32_returns_float32_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_ptr_Int32_returns_float32_C = Float Function(
    Pointer _arg0, Pointer _arg1, Pointer _arg2, Pointer _arg3, Int32 _arg4);
typedef _call_ptr_ptr_ptr_ptr_Int32_returns_float32_Dart = double Function(
    Pointer _arg0, Pointer _arg1, Pointer _arg2, Pointer _arg3, int _arg4);

final _call_ptr_ptr_ptr_ptr_Uint32_ptr_ptr_returns_Int8 = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_ptr_Uint32_ptr_ptr_returns_Int8_C,
        _call_ptr_ptr_ptr_ptr_Uint32_ptr_ptr_returns_Int8_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_ptr_Uint32_ptr_ptr_returns_Int8_C = Int8 Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Pointer onImageData,
    ...
    Pointer error);
typedef _call_ptr_ptr_ptr_ptr_Uint32_ptr_ptr_returns_Int8_Dart = int Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Pointer onImageData,
...
final _call_ptr_ptr_ptr_ptr_Uint32_ptr_returns_Int8 = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_ptr_Uint32_ptr_returns_Int8_C,
        _call_ptr_ptr_ptr_ptr_Uint32_ptr_returns_Int8_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_ptr_Uint32_ptr_returns_Int8_C = Int8 Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Pointer onImageData,
    Uint32 orientation,
    Pointer error);
typedef _call_ptr_ptr_ptr_ptr_Uint32_ptr_returns_Int8_Dart = int Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Pointer onImageData,
...
final _call_ptr_ptr_ptr_ptr_float32_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_ptr_float32_returns_ptr_C,
        _call_ptr_ptr_ptr_ptr_float32_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_ptr_float32_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Pointer predictedPersonUniqueIdentifier,
    Float confidence);
typedef _call_ptr_ptr_ptr_ptr_float32_returns_ptr_Dart = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Pointer predictedPersonUniqueIdentifier,
...
final _call_ptr_ptr_ptr_ptr_ptr_Int8_float32_float32_ptr_returns_ptr =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_ptr_ptr_ptr_Int8_float32_float32_ptr_returns_ptr_C,
            _call_ptr_ptr_ptr_ptr_ptr_Int8_float32_float32_ptr_returns_ptr_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_ptr_ptr_ptr_Int8_float32_float32_ptr_returns_ptr_C
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
        ...
        Pointer error);
typedef _call_ptr_ptr_ptr_ptr_ptr_Int8_float32_float32_ptr_returns_ptr_Dart
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
...
final _call_ptr_ptr_ptr_ptr_ptr_Int8_float32_ptr_returns_ptr =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_ptr_ptr_ptr_Int8_float32_ptr_returns_ptr_C,
            _call_ptr_ptr_ptr_ptr_ptr_Int8_float32_ptr_returns_ptr_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_ptr_ptr_ptr_Int8_float32_ptr_returns_ptr_C
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
        ...
        Float threshold,
        Pointer error);
typedef _call_ptr_ptr_ptr_ptr_ptr_Int8_float32_ptr_returns_ptr_Dart
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
...
final _call_ptr_ptr_ptr_ptr_ptr_float32_float32_ptr_returns_ptr =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_ptr_ptr_ptr_float32_float32_ptr_returns_ptr_C,
            _call_ptr_ptr_ptr_ptr_ptr_float32_float32_ptr_returns_ptr_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_ptr_ptr_ptr_float32_float32_ptr_returns_ptr_C
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
        ...
        Float torsoThreshold,
        Pointer error);
typedef _call_ptr_ptr_ptr_ptr_ptr_float32_float32_ptr_returns_ptr_Dart
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
...
final _call_ptr_ptr_ptr_ptr_ptr_float32_float32_returns_ptr =
    _objc.dlForObjectiveC.lookupFunction<
            _call_ptr_ptr_ptr_ptr_ptr_float32_float32_returns_ptr_C,
            _call_ptr_ptr_ptr_ptr_ptr_float32_float32_returns_ptr_Dart>(
        "objc_msgSend");
typedef _call_ptr_ptr_ptr_ptr_ptr_float32_float32_returns_ptr_C
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
        ...
        Float threshold,
        Float torsoThreshold);
typedef _call_ptr_ptr_ptr_ptr_ptr_float32_float32_returns_ptr_Dart
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
...
final _call_ptr_ptr_ptr_ptr_ptr_float32_ptr_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_ptr_ptr_float32_ptr_returns_ptr_C,
        _call_ptr_ptr_ptr_ptr_ptr_float32_ptr_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_ptr_ptr_float32_ptr_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Pointer cachePath,
    ...
    Float threshold,
    Pointer error);
typedef _call_ptr_ptr_ptr_ptr_ptr_float32_ptr_returns_ptr_Dart
    = Pointer Function(Pointer _arg0, Pointer _arg1, Pointer arg,
        Pointer cachePath, Pointer state, double threshold, Pointer error);

final _call_ptr_ptr_ptr_ptr_ptr_float32_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_ptr_ptr_float32_returns_ptr_C,
        _call_ptr_ptr_ptr_ptr_ptr_float32_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_ptr_ptr_float32_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Pointer cachePath,
    Pointer state,
    Float threshold);
typedef _call_ptr_ptr_ptr_ptr_ptr_float32_returns_ptr_Dart = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Pointer cachePath,
...
final _call_ptr_ptr_ptr_ptr_ptr_ptr_Uint32_returns_ptr = _objc.dlForObjectiveC
    .lookupFunction<_call_ptr_ptr_ptr_ptr_ptr_ptr_Uint32_returns_ptr_C,
        _call_ptr_ptr_ptr_ptr_ptr_ptr_Uint32_returns_ptr_Dart>("objc_msgSend");
typedef _call_ptr_ptr_ptr_ptr_ptr_ptr_Uint32_returns_ptr_C = Pointer Function(
    Pointer _arg0,
    Pointer _arg1,
    Pointer arg,
    Pointer imageBuffer,
    ...
    Uint32 qosClass);
typedef _call_ptr_ptr_ptr_ptr_ptr_ptr_Uint32_returns_ptr_Dart
    = Pointer Function(
        Pointer _arg0,
        Pointer _arg1,
        Pointer arg,
...
typedef _call_ptr_ptr_ptr_ptr_ptr_ptr_returns_ptr_C = Pointer Function(
    ...
    Pointer _arg1,
    Pointer arg,
    Pointer maxClipDuration,
    Pointer maxSequenceSummaryDuration,
    Pointer error);
...
typedef _call_ptr_ptr_ptr_ptr_returns_Uint64_C = Uint64 Function(Pointer _arg0,
    Pointer _arg1, Pointer arg, Pointer indexOfPersonWithUniqueIdentifier);
typedef _call_ptr_ptr_ptr_ptr_returns_Uint64_Dart = int Function(Pointer _arg0,
    Pointer _arg1, Pointer arg, Pointer indexOfPersonWithUniqueIdentifier);
...
typedef _call_ptr_ptr_ptr_ptr_returns_ptr_C = Pointer Function(Pointer _arg0,
    Pointer _arg1, Pointer arg, Pointer uniqueObservationClasses);
typedef _call_ptr_ptr_ptr_ptr_returns_ptr_Dart = Pointer Function(Pointer _arg0,
    Pointer _arg1, Pointer arg, Pointer uniqueObservationClasses);
...
final _call_ptr_ptr_returns_Int16 = _objc.dlForObjectiveC.lookupFunction<
    _call_ptr_ptr_returns_Int16_C,
    _call_ptr_ptr_returns_Int16_Dart>("objc_msgSend");
typedef _call_ptr_ptr_returns_Int16_C = Int16 Function(
    Pointer _arg0, Pointer _arg1);
typedef _call_ptr_ptr_returns_Int16_Dart = int Function(
    Pointer _arg0, Pointer _arg1);
